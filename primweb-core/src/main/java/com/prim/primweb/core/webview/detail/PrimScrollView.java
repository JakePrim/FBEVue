...
//        PWLog.e(TAG + ".observeWebViewHeightChange...setWebHeight:" + height);
    ...
    public void updatesWebHeight(int height) {
        PWLog.e(TAG + ".observeWebViewHeightChange...updatesWebHeight:" + height);
        if (webParentLayout != null) {
            LayoutParams layoutParams = webParentLayout.getLayoutParams();
            layoutParams.height = height;
            //设置webView高度 重新测量高度
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        PWLog.e(TAG + ".observeWebViewHeightChange...onLayout:" + changed);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        PWLog.e(TAG + ".observeWebViewHeightChange...onMeasure:" + parentHeight);
...
//                PWLog.e(TAG + ".ACTION_MOVE...mLastY:" + mLastY);
                ...
                if (Math.abs(yVelocity) > mMinimumVelocity) {
                    if (isAtTop) {
                        if (commentListView != null && commentListView.canScrollVertically(DIRECT_TOP)) {
                            PWLog.e(TAG + ".ListViewTouchHelper...commentListView.startFling:" + -yVelocity);
                            commentListView.startFling((int) -yVelocity);
                        }
                    } else if (isAtBottom) {
                        if (detailWebView != null && detailWebView.canScrollVertically(DIRECT_BOTTOM)) {
                            PWLog.e(TAG + ".ListViewTouchHelper...detailWebView.startFling:" + -yVelocity);
                            detailWebView.startFling((int) -yVelocity);
                        }
                    } else {
                        PWLog.e(TAG + ".ListViewTouchHelper..." + "scrollview fling:" + (-yVelocity) + "\n" +
...
//                    PWLog.e(TAG + ".onTouchEvent 交给webview 滚动delta:" + delta + "\n" +
//                            ".webParentLayout.getHeight()..." + webParentLayout.getHeight() + "\n" +
...
//        PWLog.e("onInterceptTouchEvent.getScrollY=" + getScrollY() + "\n"
//                + ",isWebViewScrollBottom=" + isWebViewScrollBottom + "\n"
...
//        PWLog.e(".ScrollView.fling...velocity." + velocity + "\n"
...
//        PWLog.e(".ScrollView.fling...minY..." + minY);
...
//                + "...curVelocity." + curVelocity + "\n");
        if (currY < oldY && oldY <= 0) {
            if (curVelocity != 0) {
//                PWLog.e(TAG + ".computeScroll...forceFinished.0...curVelocity:" + curVelocity);
...
//            PWLog.e(TAG + ".computeScroll...forceFinished.1");
            mScroller.forceFinished(true);
            return;
        } else if (oldY >= maxScrollY && currY > oldY) {
//            PWLog.e(TAG + ".computeScroll...forceFinished.2");
            mScroller.forceFinished(true);
            return;
        }
    ...
    private class MyOnScrollChangeListener implements OnScrollChangeListener {
        ...
        public void onChange(ViewType viewType) {
            PWLog.e("Comment-Log onChange:" + viewType);
            switch (viewType) {
                case WEB:
                ...
                commentListView.addDetailOnScrollListener(new RecyclerView.OnScrollListener() {
                    ...
                    public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                        if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                            ...
                            PWLog.d("onScrollStateChanged -> lastItemPosition:" + lastItemPosition
                                    + " itemCount:" + (itemCount - 2)
                                    + " isOnlyBottom:" + isOnlyBottom);
...
//                        isSlidingUpward = dy < 0;
                        isOnlyBottom = false;
                        PWLog.d("onScrollStateChanged -> onScrolled:" + dy);
                    }
                });
            } catch (Exception e) {
                e.printStackTrace();
    ...
    private void toComment() {
        PWLog.e("Comment-Log toComment:" + mCurrentType);
